...
function TraduzirNomePais(nome) {
  return TraducoesPais[nome] || nome; // Retorna a tradução ou o nome original se não existir
}

function carregarPaises() {
  return PaisesAmerica.map((pais) => ({
    nome: TraduzirNomePais(pais.name),
    value: TraduzirNomePais(pais.name)
  }));
}
