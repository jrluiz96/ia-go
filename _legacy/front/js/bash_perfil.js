if (typeof window.bashProfile === 'undefined') {
    window.bashProfile = {
        usuario: {},
        lastUpdate: null,
        init: function() {
        ...
        loadFromStorage: function () {
            const stored = localStorage.getItem('bashProfile');
            if (stored) {
        ...
        saveToStorage: function () {
            ...
            localStorage.setItem('bashProfile', JSON.stringify(data));
        },
        setupEventListeners: function () {
            ...
            $(document).on('submit', '#form-reset-senha', function(e) {
                e.preventDefault();
                window.bashProfile.resetarSenha();
            });
        },
        renderAll: function () {
            this.renderCardFoto();
        ...
        renderCardFoto: function() {
            ...
            console.log('Renderizando card foto para usuário:', usuario);
            let html = `
                <div class="avatar relative">
                    <div class="w-24 h-24 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 bg-neutral text-neutral-content relative">
                        <i class="fas fa-user text-4xl absolute top-1/2 left-1/2  -translate-x-1/2 -translate-y-1/2"></i>
                    </div>
                </div>
        ...
        renderContato: function() {
            const usuario = this.usuario;
            console.log('Renderizando contato para usuário:', usuario);
            let html = `
        ...
        resetarSenha: function() {
            ...
            req(`v1/sessao/change-password`, 'POST', data,
                function(res) {
                    ...
                    setTimeout(() => {
                        ...
                        window.bashProfile.mostrarPerfil();
                    }, 8000);
                },
                function(error) {
